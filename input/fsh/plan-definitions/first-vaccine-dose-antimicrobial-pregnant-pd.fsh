...
* contained[+] = Inline-Instance-Ciprofloxacin-Request-2
* contained[+] = Inline-Instance-Doxycycline-Request-2
* contained[+] = Inline-Instance-Levofloxacin-Request-2
* contained[+] = Inline-Instance-Moxifloxacin-Request-2
* contained[+] = Inline-Instance-Clindamycin-Request-2
* contained[+] = Inline-Instance-Vaccine-Request-2

Instance: Inline-Instance-Ciprofloxacin-Request-2
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Ciprofloxacin-Request-2)
* insert UseContext
...
Instance: Inline-Instance-Doxycycline-Request-2
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Doxycycline-Request-2)
* insert UseContext
...
Instance: Inline-Instance-Levofloxacin-Request-2
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Levofloxacin-Request-2)
* insert UseContext
...
Instance: Inline-Instance-Moxifloxacin-Request-2
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Moxifloxacin-Request-2)
* insert UseContext
...
Instance: Inline-Instance-Clindamycin-Request-2
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Clindamycin-Request-2)
* insert UseContext
...
Instance: Inline-Instance-Vaccine-Request-2
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Vaccine-Request-2)
* insert UseContext
