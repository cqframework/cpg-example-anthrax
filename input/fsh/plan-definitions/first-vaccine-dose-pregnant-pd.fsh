Instance: first-vaccine-dose-pregnant-pd
InstanceOf: PlanDefinition
Usage: #example
Title: "Anthrax Post Exposure Prophylaxis (PEP) for Adults"
* insert PlanDefinitionMetadata(first-vaccine-dose-pregnant-pd)
* insert UseContext
  ...
  * action[+]
    ...
    * action[+]
      ...
      * action[+]
        ...
        * definitionCanonical = "#Inline-Ciprofloxacin-Request-3"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Doxycycline-Request-3"
    * action[+]
      ...
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Levofloxacin-Request-3"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Moxifloxacin-Request-3"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Clindamycin-Request-3"
  * action[+]
    * title = "Anthrax Vaccination - 1st dose"
    * type = $action-type#create "Create"
    * definitionCanonical = "#Inline-Vaccine-Request-3"
* contained[+] = Inline-Ciprofloxacin-Request-3
* contained[+] = Inline-Doxycycline-Request-3
* contained[+] = Inline-Levofloxacin-Request-3
* contained[+] = Inline-Moxifloxacin-Request-3
* contained[+] = Inline-Clindamycin-Request-3
* contained[+] = Inline-Vaccine-Request-3

Instance: Inline-Ciprofloxacin-Request-3
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Ciprofloxacin-Request-3)
* insert UseContext
...
Instance: Inline-Doxycycline-Request-3
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Doxycycline-Request-3)
* insert UseContext
...
Instance: Inline-Levofloxacin-Request-3
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Levofloxacin-Request-3)
* insert UseContext
...
Instance: Inline-Moxifloxacin-Request-3
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Moxifloxacin-Request-3)
* insert UseContext
...
Instance: Inline-Clindamycin-Request-3
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Clindamycin-Request-3)
* insert UseContext
...
Instance: Inline-Vaccine-Request-3
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Vaccine-Request-3)
* insert UseContext
