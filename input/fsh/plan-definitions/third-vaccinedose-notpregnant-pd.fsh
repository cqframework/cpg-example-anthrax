...
* action
  * title = "Anthrax Post Exposure Prophylaxis 14"
  ...
  * action[+]
    ...
    * type = $action-type#create "Create"
    * definitionCanonical = "#Inline-Vaccine-Request-11"
...
* contained[+] = Inline-Vaccine-Request-11

Instance: Inline-Vaccine-Request-11
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Vaccine-Request-11)
* insert UseContext
