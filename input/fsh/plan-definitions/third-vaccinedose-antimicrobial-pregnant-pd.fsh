...
* contained[+] = Inline-Instance-Ciprofloxacin-Request-6
* contained[+] = Inline-Instance-Doxycycline-Request-6
* contained[+] = Inline-Instance-Levofloxacin-Request-6
* contained[+] = Inline-Instance-Moxifloxacin-Request-6
* contained[+] = Inline-Instance-Clindamycin-Request-6
* contained[+] = Inline-Instance-Vaccine-Request-6

Instance: Inline-Instance-Ciprofloxacin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Ciprofloxacin-Request-6)
* insert UseContext
...
Instance: Inline-Instance-Doxycycline-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Doxycycline-Request-6)
* insert UseContext
...
Instance: Inline-Instance-Levofloxacin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Levofloxacin-Request-6)
* insert UseContext
...
Instance: Inline-Instance-Moxifloxacin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Moxifloxacin-Request-6)
* insert UseContext
...
Instance: Inline-Instance-Clindamycin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Clindamycin-Request-6)
* insert UseContext
...
Instance: Inline-Instance-Vaccine-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Vaccine-Request-6)
* insert UseContext
