Instance: third-vaccinedose-antimicrobial-pregnant-pd
InstanceOf: PlanDefinition
Usage: #example
Title: "Third vaccine antimicrobial pregnant"
* insert PlanDefinitionMetadata(third-vaccinedose-antimicrobial-pregnant-pd)
* insert UseContext
...
* action
  * title = "Anthrax Post Exposure Prophylaxis 12"
  ...
  * action[+]
    ...
    * action[+]
      ...
      * action[+]
        ...
        * definitionCanonical = "#Inline-Ciprofloxacin-Request-6"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Doxycycline-Request-6"
    * action[+]
      ...
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Levofloxacin-Request-6"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Moxifloxacin-Request-6"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Clindamycin-Request-6"
  * action[+]
    * title = "Anthrax Vaccination - 3rd dose"
    * type = $action-type#create "Create"
    * definitionCanonical = "#Inline-Vaccine-Request-6"
* contained[+] = Inline-Ciprofloxacin-Request-6
* contained[+] = Inline-Doxycycline-Request-6
* contained[+] = Inline-Levofloxacin-Request-6
* contained[+] = Inline-Moxifloxacin-Request-6
* contained[+] = Inline-Clindamycin-Request-6
* contained[+] = Inline-Vaccine-Request-6

Instance: Inline-Ciprofloxacin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Ciprofloxacin-Request-6)
* insert UseContext
...
Instance: Inline-Doxycycline-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Doxycycline-Request-6)
* insert UseContext
...
Instance: Inline-Levofloxacin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Levofloxacin-Request-6)
* insert UseContext
...
Instance: Inline-Moxifloxacin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Moxifloxacin-Request-6)
* insert UseContext
...
Instance: Inline-Clindamycin-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Clindamycin-Request-6)
* insert UseContext
...
Instance: Inline-Vaccine-Request-6
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Vaccine-Request-6)
* insert UseContext
