Instance: second-vaccinedose-antimicrobial-notpregnant-pd
InstanceOf: PlanDefinition
Usage: #definition
Title: "Second vaccine antimicrobial not pregnant"
* insert PlanDefinitionMetadata(second-vaccinedose-antimicrobial-notpregnant-pd)
* insert UseContext
...
* action
  * title = "Anthrax Post Exposure Prophylaxis 4"
  ...
  * action[+]
    ...
    * type = $action-type#create "Create"
    * definitionCanonical = "#Inline-Vaccine-Request-8"
...
* contained[+] = Inline-Vaccine-Request-8

Instance: Inline-Vaccine-Request-8
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Vaccine-Request-8)
* insert UseContext
