...
* contained[+] = Inline-Instance-Ciprofloxacin-Request-4
* contained[+] = Inline-Instance-Doxycycline-Request-4
* contained[+] = Inline-Instance-Levofloxacin-Request-4
* contained[+] = Inline-Instance-Moxifloxacin-Request-4
* contained[+] = Inline-Instance-Clindamycin-Request-4
* contained[+] = Inline-Instance-Vaccine-Request-4

Instance: Inline-Instance-Ciprofloxacin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Ciprofloxacin-Request-4)
* insert UseContext
...
Instance: Inline-Instance-Doxycycline-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Doxycycline-Request-4)
* insert UseContext
...
Instance: Inline-Instance-Levofloxacin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Levofloxacin-Request-4)
* insert UseContext
...
Instance: Inline-Instance-Moxifloxacin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Moxifloxacin-Request-4)
* insert UseContext
...
Instance: Inline-Instance-Clindamycin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Clindamycin-Request-4)
* insert UseContext
...
Instance: Inline-Instance-Vaccine-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Instance-Vaccine-Request-4)
* insert UseContext
