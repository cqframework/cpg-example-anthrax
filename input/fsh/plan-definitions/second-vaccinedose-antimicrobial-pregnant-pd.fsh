...
Usage: #example
Title: "Second vaccine antimicrobial pregnant"
* insert PlanDefinitionMetadata(second-vaccinedose-antimicrobial-pregnant-pd)
* insert UseContext
...
* action
  * title = "Anthrax Post Exposure Prophylaxis 9"
  ...
  * action[+]
    ...
    * action[+]
      ...
      * action[+]
        ...
        * definitionCanonical = "#Inline-Ciprofloxacin-Request-4"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Doxycycline-Request-4"
    * action[+]
      ...
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Levofloxacin-Request-4"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Moxifloxacin-Request-4"
      * action[+]
        * type = $action-type#create "Create"
        * definitionCanonical = "#Inline-Clindamycin-Request-4"
  * action[+]
    * title = "Anthrax Vaccination - 2nd dose"
    * type = $action-type#create "Create"
    * definitionCanonical = "#Inline-Vaccine-Request-4"
* contained[+] = Inline-Ciprofloxacin-Request-4
* contained[+] = Inline-Doxycycline-Request-4
* contained[+] = Inline-Levofloxacin-Request-4
* contained[+] = Inline-Moxifloxacin-Request-4
* contained[+] = Inline-Clindamycin-Request-4
* contained[+] = Inline-Vaccine-Request-4

Instance: Inline-Ciprofloxacin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Ciprofloxacin-Request-4)
* insert UseContext
...
Instance: Inline-Doxycycline-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Doxycycline-Request-4)
* insert UseContext
...
Instance: Inline-Levofloxacin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Levofloxacin-Request-4)
* insert UseContext
...
Instance: Inline-Moxifloxacin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Moxifloxacin-Request-4)
* insert UseContext
...
Instance: Inline-Clindamycin-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Clindamycin-Request-4)
* insert UseContext
...
Instance: Inline-Vaccine-Request-4
InstanceOf: ActivityDefinition
Usage: #inline
* insert RequestMetadata(Inline-Vaccine-Request-4)
* insert UseContext
